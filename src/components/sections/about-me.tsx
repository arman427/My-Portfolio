                    ...
                    <div className="grid grid-cols-1 items-end gap-10 lg:grid-cols-[1fr_auto] lg:gap-60">
                        <div className="">
                            ...
                            <div className="flex flex-wrap items-center gap-5 w-fitfont-medium mb-5 sm:mb-10">
                                ...
                                <Button href="https://t.me/armanhik7" className="pill h-11 px-10 text-sm" variant="outline">
                                    Телеграм
                                </Button>
                                <Button href="mailto:babayananuta11@gmail.com" className="pill h-11 px-10 text-sm" variant="outline">
                                    Почта
                                </Button>
                            </div>
                            <div className="flex gap-5">
                                {
                                    ABOUT_SOCIAL.map((icon) => (
                                        <a
                                            ...
                                            href={icon.href}
                                            className={cn(
                                                "group relative grid p-3 shrink-0 hover:bg-accent hover:text-white active:bg-accent active:text-white duration-400",
                        ...
                        {/* Картинка (слот для Flip-анимации) */}
                        <div className="relative h-[450px] w-[370px] shrink-0 overflow-hidden rounded-3xl about-image hidden md:block">
